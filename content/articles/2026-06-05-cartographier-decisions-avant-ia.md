---
title: "Avant de déployer l'IA, avez-vous cartographié vos décisions ?"
date: 2026-06-05
...
cover:
    ...
    caption: "Decision Day 2026, ateliers selon la méthode IHEDN — 5 juin 2026"
    relative: false
    hidden: false
---
...
- [Decision Day 2026](https://www.decisionday2026.com/**), organisé le 5 juin 2026 aux Invalides à Paris — journée de réflexion sur la gouvernance des décisions à l'ère de l'IA.

### Les intervenants cités

- **Général de corps d'armée Loïc Mizon**, gouverneur militaire de Paris depuis le 1er octobre 2024.
  [Biographie officielle — Armée de Terre](https://www.terre.defense.gouv.fr/gmp/biographie-du-general-corps-darmee-loic-mizon)
- **Guillaume Lasconjarias**, directeur des études et de la recherche à l'Institut des Hautes Études de Défense Nationale (IHEDN).
  [Profil IHEDN](https://ihedn.fr/)
...
- **IHEDN — Institut des Hautes Études de Défense Nationale**, organisme de formation et de recherche sur les enjeux de défense et de sécurité nationale, dont la méthode des "War Rooms" est appliquée à la décision stratégique.
  [ihedn.fr](https://ihedn.fr/)
- **Continuous Architecture**, pratique d'architecture évolutive et dialogue continu entre stratégie et exécution.
...
- *L'architecte d'entreprise, stratège du réel — pas constructeur de SI* — article de mars 2026, qui pose la même question sous l'angle géopolitique. [Lire l'article](/articles/2026-03-15-architecte-stratege-du-reel/)
- *L'Architecture Continue face à l'imprévisible (2026)* — dossier d'analyse stratégique complet. [Consulter le dossier](/dossiers/architecture-continue-polycrise-2026.html)
